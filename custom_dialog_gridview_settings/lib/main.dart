...
class GridOptions{
  ...
  @override 
  String toString(){
    return 'GridOptions{_crossAxisCountPortrait: $_crossAxisCountPortrait, _crossAxisLandscape: $_crossAxisCountLandscape, _childAspectRatio: $_childAspectRatio, _padding: $_padding, _spacing: $_spacing}';
  }
}
...
class CustomDialogWidget extends StatefulWidget{
  ...
  @override 
  _CustomDialogWidgetState createState() => _CustomDialogWidgetState(GridOptions.copyOf(this._gridOptions));
}
      ...
      body: OrientationBuilder(
        builder: (context, orientation){
          return GridView.count(
            crossAxisCount: (orientation == Orientation.portrait) ? _gridOptions._crossAxisCountPortrait : _gridOptions._crossAxisCountLandscape,
