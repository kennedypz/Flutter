        ...
        child: Column(
          ...
          children: <Widget>[
            GestureDetector(
              ...
              onVerticalDragStart: (details) => _logGesture('onVerticalDragStart: $details'),
              onVerticalDragUpdate: (details) => _logGesture('onVerticalDragUpdate: $details'),
              onVerticalDragEnd: (details) => _logGesture('onVerticalDragEnd: $details'),
              onVerticalDragCancel: () => _logGesture('onVerticalDragCancel'),
              onHorizontalDragDown: (details) => _logGesture('onHorizontalDragDown: $details'),
              onHorizontalDragStart: (details) => _logGesture('onHorizontalDragStart: $details'),
              onHorizontalDragUpdate: (details) => _logGesture('onHorizontalDragUpdate: $details'),
              onHorizontalDragEnd: (details) => _logGesture('onHorizontalDragEnd: $details'),
